  ...
  "src/app/data/translations.ts"() {
    ...
    TRANSLATIONS = {
      en: {
        ...
        "footer.copyright": "\xA9 2026 kuza Capital Finance",
        // Expert Detail Page
      ...
      sw: {
        ...
        "products.kuzaMaishaFullDesc": "KUZA Academy ni jukwaa la kuwezesha maisha ambalo linatoa huduma muhimu za kifedha na zisizo za kifedha kwa watu binafsi na kaya. Kutoka mafunzo ya ujuzi na kujenga uwezo hadi ufadhili mdogo na programu za maendeleo ya jamii.",
    ...
    <div appScrollReveal="fade-up" class="footer-grid">
      ...
      <div class="footer-brand">
        ...
        <div class="footer-logo-wrapper">
          <img src="assets/kuzalogo2.png" alt="KUZA Logo" class="footer-logo" />
        </div>
      ...
      <div>
        ...
        <ul class="footer-col-list">
          <li><a href="#" class="footer-col-link">Kuza Sokoni</a></li>
          <li><a href="#" class="footer-col-link">Kuza Academy</a></li>
          <li><a href="#" class="footer-col-link">Kuza Pay</a></li>
          <li><a href="#" class="footer-col-link">Kuza Biashara</a></li>
          <li><a href="#" class="footer-col-link">Kuza Kilimo</a></li>
        </ul>
      </div>
