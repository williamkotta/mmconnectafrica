...
export const TRANSLATIONS: TranslationMap = {
  en: {
    ...
    'hero.description':
      'MMConnect Africa is a technology group creating the platforms and infrastructure that power everyday life — from finance to energy, mobility to sustainability.',
    ...
    'products.kuzaSokoniDesc':
      'KUZA Sokoni is a digital solution empowering Tanzanian market vendors with financial and non-financial services. It aims to create a sustainable and efficient ecosystem through digital tools and tailored services.',
    'products.kuzaMaisha': 'Kuza Academy',
    'products.kuzaMaishaDesc':
      'KUZA Academy is a digital solution empowering Tanzanian market vendors with financial and non-financial services. It aims to create a sustainable and efficient ecosystem through digital tools and tailored services.',
    'products.kuzaPay': 'Kuza Pay',
    'products.kuzaPayDesc':
      'KUZA Pay is a digital solution empowering Tanzanian market vendors with financial and non-financial services. It aims to create a sustainable and efficient ecosystem through digital tools and tailored services.',
    'products.kuzaBiashara': 'Kuza Biashara',
    'products.kuzaBiasharaDesc':
      'KUZA Biashara is a digital solution empowering Tanzanian market vendors with financial and non-financial services. It aims to create a sustainable and efficient ecosystem through digital tools and tailored services.',
    'products.kuzaKilimo': 'Kuza Kilimo',
    'products.kuzaKilimoDesc':
      'KUZA Kilimo is a digital solution empowering Tanzanian market vendors with financial and non-financial services. It aims to create a sustainable and efficient ecosystem through digital tools and tailored services.',
    'products.kuzaSpecialGroup': 'KUZA Special Group / Wafanyakazi',
    'products.kuzaSpecialGroupDesc':
      "KUZA Special Group (Wafanyakazi) provides targeted support and services for employees, workers' groups, and special categories in Tanzania. It offers financial inclusion, savings, loans, and capacity-building tools to enhance livelihoods and workplace productivity in the informal and formal sectors.",
    'products.kuzaBoda': 'KUZA Boda',
    'products.kuzaBodaDesc':
      'KUZA Boda is a specialized digital platform designed for boda boda (motorcycle taxi) operators in Tanzania. It delivers tailored financial services such as quick loans, insurance, savings, and business management tools, along with non-financial support like safety training and rider community features to promote sustainable income and safer operations.',
    'products.kuzaSokoniFullDesc':
      'KUZA Sokoni is a comprehensive digital solution designed to transform market operations across Tanzania. By empowering vendors with access to financial services, digital record-keeping, inventory management, and customer engagement tools, it creates a sustainable and efficient marketplace ecosystem. The platform bridges the gap between traditional market trading and modern digital commerce, enabling vendors to grow their businesses, access credit, and connect with a wider customer base.',
    'products.kuzaMaishaFullDesc':
      'KUZA Academy is a holistic livelihood empowerment platform that provides individuals and households with access to essential financial and non-financial services. From skills training and capacity building to micro-financing and community development programs, KUZA Academy is designed to uplift communities and create pathways to sustainable prosperity across Tanzania.',
    'products.kuzaPayFullDesc':
      'KUZA Pay is a cutting-edge financial technology solution that enables seamless digital payments, low-cost money transfers, and mobile banking services. Integrated with major mobile money platforms, it provides secure, fast, and affordable transaction processing for individuals and small businesses across Tanzania.',
    'products.kuzaBiasharaFullDesc':
      'KUZA Biashara is a comprehensive business solutions platform that supports emerging businesses and SMEs with registration, compliance, access to credit, digital management tools, and mentorship. It creates an enabling environment for business growth through strategic partnerships and networking opportunities.',
    'products.kuzaKilimoFullDesc':
      'KUZA Kilimo leverages agricultural technology to empower farmers with smart farming tools, advisory services, market linkage, and access to agricultural financing. It provides weather forecasts, crop management insights, and connects farmers directly to buyers for better prices and sustainable livelihoods.',
    'products.kuzaSpecialGroupFullDesc':
      "KUZA Special Group (Wafanyakazi) provides targeted support and services for employees, workers' groups, and special categories in Tanzania. Through financial inclusion programs, savings schemes, accessible loans, and capacity-building workshops, it enhances livelihoods and workplace productivity across both formal and informal sectors.",
    // Ecosystem Overview Cards (existing site mapping)
    'ecosystem.kuzaCapital': 'Kuza Capital',
    'ecosystem.kuzaCapitalDesc':
      'Inclusive Finance accessible to market vendors, boda boda riders, SMEs, and salaried individuals—powered by digital disbursement and flexible repayment for real financial inclusion.',
    'ecosystem.kuzaCapitalFullDesc':
      'Kuza Capital delivers inclusive finance—accessible loans and financial services for market vendors, boda boda riders, SMEs, and salaried individuals. With digital disbursement and flexible repayment, we turn access into real financial inclusion.',

    'ecosystem.tiketika': 'Tiketika',
    'ecosystem.tiketikaDesc':
      'Tanzania’s all-in-one lifestyle & booking platform for event ticketing, travel booking, and lifestyle experiences—available on web, mobile, USSD, and WhatsApp.',
    'ecosystem.tiketikaFullDesc':
      'Tiketika is Tanzania’s all-in-one platform for event ticketing, travel booking, and lifestyle experiences. It works across web, mobile, USSD, and WhatsApp—one platform, every channel.',

    'ecosystem.jibusti': 'Jibusti',
    'ecosystem.jibustiDesc':
      'On-the-go power bank rentals and backup energy solutions—locate, rent, charge, and return—so individuals and businesses stay powered.',
    'ecosystem.jibustiFullDesc':
      'Jibusti provides on-the-go power bank rentals and backup energy solutions for individuals and businesses. Locate. Rent. Charge. Return. Stay powered.',

    'ecosystem.mmcarbon': 'MMCarbon',
    'ecosystem.mmcarbonDesc':
      'Carbon management, offset solutions, clean energy initiatives, and environmental project development—building a sustainable future from the ground up.',
    'ecosystem.mmcarbonFullDesc':
      'MMCarbon offers carbon management, offset solutions, clean energy initiatives, and environmental project development—building a sustainable future from the ground up.',
    ...
    'focus.pyramidDesc':
      'At the Bottom of the Pyramid, we transform potential into shared prosperity by empowering underserved communities. Through access to resources, training, and opportunities, we unlock economic growth from the ground. Together, we build pathways to financial inclusion, fostering a future where everyone can thrive.',

    // CTA Section
    'cta.expertsHeading': 'Meet the Minds Powering Our Vision',
    'cta.viewMore': 'View More',
    'cta.bodyText':
      "We are committed to build a shared success whereas we uplift underserved segments of society. We're ensuring a model of growth that's sustainable, impactful, and rewarding for all stakeholders in the ecosystem.",
    'cta.joinUs': 'Join Us!',
    ...
    'placeholder.description':
      'This page is currently under development. Continue customizing this page by prompting the assistant with your specific requirements.',
    ...
    'features.strategicPlanningDesc':
      'Comprehensive business strategy development tailored to your goals and market position.',
    'features.digitalTransformation': 'Digital Transformation',
    'features.digitalTransformationDesc':
      'Modernize your operations with cutting-edge digital technologies and solutions.',
    'features.marketAnalysis': 'Market Analysis',
    'features.marketAnalysisDesc':
      'Deep insights into market trends and competitive landscape for informed decisions.',
    'features.implementationSupport': 'Implementation Support',
    'features.implementationSupportDesc':
      'Full-spectrum support throughout the implementation and deployment process.',
    ...
    'comment.error':
      'Failed to send message. Please try again or email us directly at architectwills@gmail.com',
  ...
  sw: {
    ...
    'mission.text':
      'Kuangazia umuhimu wa ujumuishaji na uwezekano ili kuhakikisha hakuna ndoto inayobaki bila msaada hasa kwa vijana, biashara zinazoibuka, na wale walio chini ya piramidi barani Afrika.',
    'vision.title': 'Maono',
    'vision.text':
      'Ili kufikia ukuaji wa pamoja na ustawi wa pamoja, ni muhimu kuunda mikakati na mifumo inayofaidisha kila mtu ndani ya jamii au shirika. Mchakato huu unahitaji ushirikiano katika sekta za kijamii, kiuchumi, na kiserikali ili kuhakikisha rasilimali, fursa na faida zinawafikia watu kwa usawa.',
    ...
    'products.kuzaSokoni': 'Kuza Sokoni',
    'products.kuzaSokoniDesc':
      'KUZA Sokoni ni suluhisho la kidijitali linalowapa nguvu wachuuzi wa masoko ya Tanzania kwa huduma za kifedha na zisizo za kifedha. Inalenga kuunda mfumo endelevu na wenye ufanisi kupitia zana za kidijitali na huduma maalum.',
    'products.kuzaMaisha': 'Kuza Academy',
    'products.kuzaMaishaDesc':
      'KUZA Academy ni suluhisho la kidijitali linalowapa nguvu wachuuzi wa masoko ya Tanzania kwa huduma za kifedha na zisizo za kifedha. Inalenga kuunda mfumo endelevu na wenye ufanisi kupitia zana za kidijitali na huduma maalum.',
    'products.kuzaPay': 'Kuza Pay',
    'products.kuzaPayDesc':
      'KUZA Pay ni suluhisho la kidijitali linalowapa nguvu wachuuzi wa masoko ya Tanzania kwa huduma za kifedha na zisizo za kifedha. Inalenga kuunda mfumo endelevu na wenye ufanisi kupitia zana za kidijitali na huduma maalum.',
    'products.kuzaBiashara': 'Kuza Biashara',
    'products.kuzaBiasharaDesc':
      'KUZA Biashara ni suluhisho la kidijitali linalowapa nguvu wachuuzi wa masoko ya Tanzania kwa huduma za kifedha na zisizo za kifedha. Inalenga kuunda mfumo endelevu na wenye ufanisi kupitia zana za kidijitali na huduma maalum.',
    'products.kuzaKilimo': 'Kuza Kilimo',
    'products.kuzaKilimoDesc':
      'KUZA Kilimo ni suluhisho la kidijitali linalowapa nguvu wachuuzi wa masoko ya Tanzania kwa huduma za kifedha na zisizo za kifedha. Inalenga kuunda mfumo endelevu na wenye ufanisi kupitia zana za kidijitali na huduma maalum.',
    'products.kuzaSpecialGroup': 'KUZA Kundi Maalum / Wafanyakazi',
    'products.kuzaSpecialGroupDesc':
      'KUZA Kundi Maalum (Wafanyakazi) inatoa msaada na huduma zinazolengwa kwa wafanyakazi, makundi ya wafanyakazi, na makundi maalum nchini Tanzania. Inatoa ujumuishaji wa kifedha, akiba, mikopo, na zana za kujenga uwezo ili kuboresha maisha na tija mahali pa kazi katika sekta rasmi na isiyo rasmi.',
    'products.kuzaBoda': 'KUZA Boda',
    'products.kuzaBodaDesc':
      'KUZA Boda ni jukwaa maalum la kidijitali lililoundwa kwa waendesha bodaboda nchini Tanzania. Linatoa huduma za kifedha kama mikopo ya haraka, bima, akiba, na zana za usimamizi wa biashara, pamoja na msaada usio wa kifedha kama mafunzo ya usalama na vipengele vya jamii ya madereva ili kukuza mapato endelevu na shughuli salama.',
    ...
    'focus.youthDesc':
      'Kujitolea kuhudumia vijana wa Afrika, tunawapa nguvu akili za vijana kwa fursa mpya na rasilimali za kuunda mustakabali wao. Kwa kukuza elimu, ujasiriamali, na uongozi, tunasaidia safari yao kuelekea Afrika yenye ustawi na inayojitegemea. Pamoja, tunaunda njia za vijana wa Afrika kuendesha mabadiliko endelevu.',
    ...
    'comment.error':
      'Imeshindwa kutuma ujumbe. Tafadhali jaribu tena au tutumie barua pepe moja kwa moja architectwills@gmail.com',
    ...
    'placeholder.description':
      'Ukurasa huu bado unatengenezwa. Endelea kuboresha ukurasa huu kwa kutoa maelekezo kwa msaidizi kulingana na mahitaji yako maalum.',
